...
public class Breakout extends WindowProgram {
    ...
    /**
     * Random number for dela x. Use rgen for determine random ball delta x.
     */
    ...
    private void messageIfLose() {
        ...
        gameOver.setLocation(getWidth() / 2.0 - gameOver.getWidth() / 2, gameOver.getHeight());
        add(gameOver);
        ...
        scores.setLocation((getWidth() / 2.0 - scores.getWidth() / 2), gameOver.getHeight() + scores.getHeight());
        add(scores);
        ...
        playAgain.setLocation(getWidth() / 2.0 - playAgain.getWidth() / 2, gameOver.getHeight() + scores.getHeight() + playAgain.getHeight());
        add(playAgain);
    }
    ...
    private void messageIfWin() {
        ...
        playerWin.setLocation((getWidth() / 2.0 - playerWin.getWidth() / 2), playerWin.getHeight());
        add(playerWin);

        GLabel scores = new GLabel("Your score is " + (NBRICK_ROWS * NBRICKS_PER_ROW));
        scores.setColor(Color.BLUE);
        scores.setFont(new Font("San-serif", Font.BOLD, 18));
        scores.setLocation((getWidth() / 2.0 - scores.getWidth() / 2), playerWin.getHeight() + scores.getHeight());
        add(scores);
